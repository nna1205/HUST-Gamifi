        ...
        <>
            ...
            <section name="features" className="flex flex-col justify-center items-center my-20 bg-red-500 w-screen px-10 py-6 lg:flex-row">
                <div className="w-full lg:w-1/2">
                    ...
                    <div className="">
                        <Image width={300} height={300} src="/hust student.png" alt="hust student" title="hust student"/>
                    </div>
                </div>
                <div ref={ref} className={`${inViewport ? 'animate__fadeInBottomLeft' : ''} w-full bg-white text-black rounded-md p-4 my-4 shadow-md lg:w-1/2 lg:p-6 lg:my-0`}>
